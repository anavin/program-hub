...
insert into program_hub.programs (name, description, category, icon, status, visibility, owner, note, links, sort) values
  ('Lab Parfumo PO Pro', 'ระบบใบสั่งซื้อ + รับของ + งบประมาณ ครบวงจร', 'ปฏิบัติการ', '📦', 'ok', 'all', 'ทีมจัดซื้อ', 'ต้องล็อกอินก่อนใช้งาน', '[{"label":"เปิด","url":"https://lab-parfumo-next.vercel.app"}]', 10),
  ('ระบบใบเบิกกลาง (CTW)', 'ใบเบิกของ + dashboard รวม สำหรับทุกแผนก', 'ปฏิบัติการ', '🧾', 'ok', 'all', 'ส่วนกลาง', '', '[{"label":"เปิด","url":"https://lab-parfumo-central.vercel.app"}]', 20),
  ('ระบบสต๊อกวัตถุดิบ (STOCK)', 'จัดการสต๊อกน้ำหอม/วัตถุดิบ', 'ปฏิบัติการ', '🧴', 'ok', 'all', 'คลังสินค้า', '', '[{"label":"เปิด","url":"https://labparfumo-stock.vercel.app"}]', 30),
  ...
  ('Content OS', 'Marketing dashboard รวม Meta · GA4 · YouTube · TikTok', 'การตลาด', '📈', 'ok', 'admin', 'ทีมการตลาด', '', '[{"label":"เปิด","url":"https://content-os-zeta-flax.vercel.app"}]', 60),
  ...
  ('NWM74', 'เว็บแอป NWM74 (แก้คำอธิบายได้ในโหมดแอดมิน)', 'อื่นๆ', '🌐', 'ok', 'all', '', '', '[{"label":"เปิด","url":"https://nwm74.vercel.app"}]', 165),
  ('ระบบเบิกสินค้าแยกแพลตฟอร์ม', 'เบิกสินค้าคลังกลาง (Shopee ฯลฯ) + พิมพ์ใบเบิก/บาร์โค้ด + นับสต๊อก', 'ปฏิบัติการ', '🚚', 'ok', 'all', 'คลังสินค้า', '', '[{"label":"หลัก","url":"#"}]', 32),
  ('ระบบลงโอที (OT)', 'บันทึก/สรุปชั่วโมงโอทีของพนักงาน', 'ปฏิบัติการ', '⏱️', 'ok', 'all', 'HR', '', '[{"label":"เปิด","url":"https://ot-seven-beryl.vercel.app"}]', 34),
  ('เว็บไซต์ labparfumo.com', 'หน้าร้านออนไลน์ (WordPress/WooCommerce)', 'การตลาด', '🌐', 'ok', 'all', 'การตลาด', '', '[{"label":"เปิดเว็บ","url":"https://labparfumo.com"}]', 62),
  ('PrettyCash (เงินสดย่อย)', 'แทนไฟล์ Excel เงินสดย่อย + ปิดรอบบัตรค่ายิงแอด', 'รายงาน', '💵', 'ok', 'admin', 'บัญชี', 'ต้องล็อกอิน', '[{"label":"เปิด","url":"https://prettycash.vercel.app/login"}]', 75),
  ('ดึงยอดภาษีสรรพสามิต (ภส.07-02)', 'ดึงยอด (๑๐.๑) จาก PDF เติมเทมเพลตยื่นภาษี', 'เครื่องมือ', '🧾', 'ok', 'admin', 'บัญชี', '', '[{"label":"เปิด","url":"#"}]', 145),
  ('Program Hub', 'พอร์ทัลรวมโปรแกรมทั้งหมด (หน้านี้เอง)', 'ผู้ดูแลระบบ', '🧭', 'ok', 'admin', 'ส่วนกลาง', '', '[{"label":"หลัก","url":"#"}]', 152),
  ('App Starter (แม่แบบ)', 'โครงมาตรฐานสร้างแอปใหม่ (Next.js + Supabase)', 'ผู้ดูแลระบบ', '🔷', 'ok', 'admin', 'dev', 'GitHub template', '[{"label":"GitHub","url":"https://github.com/anavin/app-starter"}]', 154)
